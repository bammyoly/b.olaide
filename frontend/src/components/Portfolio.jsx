...
const projects = [
    {
    title: 'Nullyield',
    description: 'Confidential no-loss prize savings on Ethereum Sepolia — powered by Zama fhEVM and ERC-7984.',
    tags: ['React', 'Wagmi', 'Zama SDK', 'ERC 7984', 'Solidity', 'TailwindCSS'],
    link: 'https://nullyield.vercel.app/'
  },
    {
    title: 'Optava AI',
    description: 'A memory-first AI project management app that uses CockroachDB vector indexing and Amazon Bedrock to store, retrieve, and reason over project history. ',
    tags: ['NextJS', 'Vector Indexing', 'Typescript', 'ExpressJS', 'CockroachDB', 'AWS Bedrock', 'TailwindCSS', 'Claude Agent SDK', 'Agentic Automation'],
    link: 'https://optava.vercel.app/'
  },
    {
    title: 'ZeroRemit',
    ...
    tags: ['React', 'PostgreSQL', 'ExpressJS', 'Prisma', 'Reown AppKit', 'Solidity', 'Tailwind', 'Telegram API', 'Claude MCP'],
    link: 'https://zeroremit.vercel.app/'
  },
  {
    title: 'Bursa',
